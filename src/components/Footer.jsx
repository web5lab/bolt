      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-10">
            ...
            <div className='hidden md:block'>
              <h3 className="text-white font-bold mb-6 text-lg">
                <span className="bg-clip-text text-transparent bg-gradient-to-r from-purple-400 to-indigo-400">Product</span>
              </h3>
            ...
            <div className='hidden md:block'>
              <h3 className="text-white font-bold mb-6 text-lg">
                <span className="bg-clip-text text-transparent bg-gradient-to-r from-emerald-400 to-cyan-400">Company</span>
              </h3>
              <ul className="space-y-3 text-sm">
            ...
            <div className='hidden md:block'>
              <h3 className="text-white font-bold mb-6 text-lg">
                <span className="bg-clip-text text-transparent bg-gradient-to-r from-yellow-400 to-orange-400">Resources</span>
              </h3>
              <ul className="space-y-3 text-sm">
        ...
        <div className="py-8 flex flex-col items-center sm:flex-row sm:justify-between gap-4 sm:gap-0 text-center">
          <div className="text-slate-500 text-sm">
            ...
            <span className="bg-clip-text text-transparent bg-gradient-to-r from-purple-400 to-indigo-400 font-medium">redesignr.ai</span>. All rights reserved.
          </div>
