...
const Hero: React.FC = () => {
  ...
  return (
    <section className="relative min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-cyan-50 overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute top-32 right-1/4 animate-float">
          <div className="w-12 h-12 bg-white/80 backdrop-blur-sm shadow-lg flex items-center justify-center border-2 border-blue-200" style={{borderRadius: '15px 10px 20px 15px'}}>
            <Clock className="w-6 h-6 text-blue-500" />
          </div>
        </div>
        <div className="absolute bottom-1/3 left-1/4 animate-float" style={{ animationDelay: '1s' }}>
          <div className="w-12 h-12 bg-white/80 backdrop-blur-sm shadow-lg flex items-center justify-center border-2 border-blue-200" style={{borderRadius: '10px 20px 15px 25px'}}>
            <CheckCircle className="w-6 h-6 text-indigo-500" />
          </div>
        </div>
        <div className="absolute top-1/2 right-12 animate-float" style={{ animationDelay: '2s' }}>
          <div className="w-12 h-12 bg-white/80 backdrop-blur-sm shadow-lg flex items-center justify-center border-2 border-blue-200" style={{borderRadius: '20px 15px 25px 10px'}}>
      ...
      <div className="relative container mx-auto px-6 pt-32 pb-20">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center min-h-[80vh]">
          ...
          <div className="text-center lg:text-left space-y-8">
            {/* Badge */}
            <div className="inline-flex items-center space-x-2 bg-white/80 backdrop-blur-sm px-4 py-2 shadow-lg border-2 border-blue-300" style={{
              borderRadius: '25px 15px 30px 20px',
              boxShadow: '3px 3px 0px rgba(59, 130, 246, 0.3)'
            }}>
              <Star className="w-4 h-4 text-blue-500 fill-current" />
              <span className="text-sm font-semibold text-slate-700">⭐ Trusted by 50,000+ users</span>
            </div>
              ...
              <h1 className="text-6xl md:text-6xl lg:text-7xl font-black leading-tight">
                <span className="block text-slate-800 relative">
                  ...
                  <svg className="absolute -bottom-2 left-0 w-full h-3" viewBox="0 0 300 12" fill="none">
                    <path d="M5 8 Q150 2 295 8" stroke="#3b82f6" strokeWidth="3" strokeLinecap="round" fill="none" opacity="0.6"/>
                  </svg>
                </span>
              ...
              <p className="text-xl md:text-2xl text-slate-600 max-w-2xl leading-relaxed">
                ...
                <span className="text-blue-600 font-semibold relative">
                  ...
                  <svg className="absolute -bottom-1 left-0 w-full h-2" viewBox="0 0 200 8" fill="none">
                    <path d="M2 6 Q100 2 198 6" stroke="#3b82f6" strokeWidth="2" strokeLinecap="round" fill="none" opacity="0.4"/>
                  </svg>
                </span>{' '}
                that understands natural language and keeps you perfectly organized. ✨
              </p>
            </div>

            {/* Key Benefits */}
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 py-6">
              <div className="flex items-center justify-center lg:justify-start space-x-3 p-4 bg-white/60 backdrop-blur-sm border-2 border-blue-200" style={{borderRadius: '20px 15px 25px 10px'}}>
                <div className="w-10 h-10 bg-gradient-to-r from-blue-500 to-indigo-500 flex items-center justify-center" style={{borderRadius: '12px 8px 15px 10px'}}>
                  <Mic className="w-5 h-5 text-white" />
                </div>
                <div className="text-left">
                  <div className="font-bold text-slate-800">🎤 Voice Control</div>
                  <div className="text-sm text-slate-600">Just speak naturally</div>
                </div>
              </div>
              <div className="flex items-center justify-center lg:justify-start space-x-3 p-4 bg-white/60 backdrop-blur-sm border-2 border-blue-200" style={{borderRadius: '15px 25px 10px 20px'}}>
                <div className="w-10 h-10 bg-gradient-to-r from-indigo-500 to-purple-500 flex items-center justify-center" style={{borderRadius: '10px 15px 8px 12px'}}>
                  <Bot className="w-5 h-5 text-white" />
                </div>
                <div className="text-left">
                  <div className="font-bold text-slate-800">🤖 Smart AI</div>
                  <div className="text-sm text-slate-600">Learns your habits</div>
                </div>
              </div>
              <div className="flex items-center justify-center lg:justify-start space-x-3 p-4 bg-white/60 backdrop-blur-sm border-2 border-blue-200" style={{borderRadius: '25px 10px 20px 15px'}}>
                <div className="w-10 h-10 bg-gradient-to-r from-cyan-500 to-blue-500 flex items-center justify-center" style={{borderRadius: '8px 12px 15px 10px'}}>
                  <CheckCircle className="w-5 h-5 text-white" />
                </div>
                <div className="text-left">
                  <div className="font-bold text-slate-800">✅ Never Forget</div>
                  <div className="text-sm text-slate-600">100% reliable</div>
                </div>
              </div>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-4">
              <button className="group relative px-8 py-4 bg-gradient-to-r from-blue-500 to-indigo-600 text-white font-bold shadow-xl hover:shadow-2xl transform hover:scale-105 transition-all duration-300 overflow-hidden" style={{
                borderRadius: '25px 15px 30px 20px',
